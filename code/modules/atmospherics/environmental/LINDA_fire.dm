...
/obj/effect/hotspot/proc/update_color()
	...
	if(temperature > 4500000) //This is where noblium happens. Some fusion-y effects.
		...
		var/mutable_appearance/fusion_overlay = mutable_appearance('icons/effects/tile_effects.dmi', "fusion_gas")
	...
	light_color = rgb(LERP(250, heat_r, greyscale_fire), LERP(160, heat_g, greyscale_fire), LERP(25, heat_b, greyscale_fire))
