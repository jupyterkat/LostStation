...
/datum/crewmonitor/New()
	...
	src.interfaces = list()
	src.data = list()
	SSassets.transport.register_asset("crewmonitor.js",'crew.js')
	SSassets.transport.register_asset("crewmonitor.css",'crew.css')
...
/datum/crewmonitor/proc/sendResources(var/client/client)
	SSassets.transport.send_assets(client, "crewmonitor.js")
	SSassets.transport.send_assets(client, "crewmonitor.css")
