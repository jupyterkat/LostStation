...
/mob/proc/say_dead(var/message)
	...
	var/rendered = "<span class='game deadsay'><span class='prefix'>STAT_DEAD:</span> <span class='name'>[src.client.prefs.chat_toggles & CHAT_ANONDCHAT ? "" : "([key]) "][name]</span>[alt_name] <span class='message'>[message]</span></span>"
